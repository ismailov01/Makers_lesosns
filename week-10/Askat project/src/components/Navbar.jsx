...
export default function Navbar() {
  ...
  const {getPhones, phoneCountInCart} = React.useContext(clientContext)
        ...
        <Toolbar>
          ...
          <Link to="/cart">
            <IconButton
              ...
              color="inherit"
              >
              <Badge badgeContent={phoneCountInCart} color="error">
                <ShoppingCart />
              </Badge>
            </IconButton>
            </Link>
            ...
            >
              <Logout />
                ...
                <Button onClick={authWithGoogle} color="inherit">Sign In</Button>
              )
            }
          </Box>
